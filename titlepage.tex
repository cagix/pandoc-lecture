...
\renewcommand{\maketitle}{
    ...
    \begin{minipage}[c]{0.72\textwidth}
        ...
        \textcolor{headcolor}{\Large\textbf{$title$}}\\[2ex]
        $if(ilias)$
    ...
    \begin{minipage}[c]{0.28\textwidth}
        \hfill
        $if(ilias)$
            \mbox{\includegraphics[width=40mm]{figs/front_fh-bielefeld}}
        $else$
            \mbox{\includegraphics[width=34mm]{figs/front_fh-bielefeld}}
        $endif$
    \end{minipage}
