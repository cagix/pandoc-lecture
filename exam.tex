...
\newcommand{\hslogo}{figs/front_fh-bielefeld}
...
%\newcommand{\Fortsetzung}{\vfill\centerline{\textsl{\textbf{Fortsetzung nächste Seite}}}\clearpage}
...
{
    \smallskip
    \begin{tabular}{>{\columncolor{gray}}p{1pt}p{0.94\textwidth}}
        &
...
%\htword{\raisebox{-2mm}[6mm][4mm]{\textcolor{headcolor}{\Huge\ensuremath{\;\;\;\pmb{\Sigma}\;\;\;}}}}
